...
const CartScreen = ({ navigation }) => {
  ...
  const orderData = {
    customerName: auth.currentUser,
    orderDate: new Date(),
    items: cart, // Assuming you have a cartItems array
  };
  ...
  //   uid = await AsyncStorage.getItem("cart");
  ...
  //       tempDart.push(item);
  //     }
  //     getFirestoreirestore().collection("users").doc(uid).update({
  //       cart: tempDart,
  //     });
  //   } else {
  //     tempDart.push(item);
